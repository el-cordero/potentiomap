...
#> 1    IDW /tmp/RtmpbHazRA/gw_IDW_surface.tif /tmp/RtmpbHazRA/gw_IDW_contours.shp
#>                              quicklook
#> 1 /tmp/RtmpbHazRA/gw_IDW_quicklook.png
#>                              contour_manifest
#> 1 /tmp/RtmpbHazRA/gw_IDW_contour_manifest.csv
```
