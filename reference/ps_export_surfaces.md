...
#> 1    IDW /tmp/RtmpqVLtWR/gw_IDW_surface.tif /tmp/RtmpqVLtWR/gw_IDW_contours.shp
#>                              quicklook
#> 1 /tmp/RtmpqVLtWR/gw_IDW_quicklook.png
#>                              contour_manifest
#> 1 /tmp/RtmpqVLtWR/gw_IDW_contour_manifest.csv
```
