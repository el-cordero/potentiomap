...
#> 1    IDW /tmp/Rtmpad3ChN/gw_IDW_surface.tif /tmp/Rtmpad3ChN/gw_IDW_contours.shp
#>                              quicklook
#> 1 /tmp/Rtmpad3ChN/gw_IDW_quicklook.png
#>                              contour_manifest
#> 1 /tmp/Rtmpad3ChN/gw_IDW_contour_manifest.csv
```
