...
#> 1    IDW /tmp/RtmpGIpMvq/gw_IDW_surface.tif /tmp/RtmpGIpMvq/gw_IDW_contours.shp
#>                              quicklook
#> 1 /tmp/RtmpGIpMvq/gw_IDW_quicklook.png
#>                              contour_manifest
#> 1 /tmp/RtmpGIpMvq/gw_IDW_contour_manifest.csv
```
