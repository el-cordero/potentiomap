...
#> 1    IDW /tmp/Rtmp0c0xKz/gw_IDW_surface.tif /tmp/Rtmp0c0xKz/gw_IDW_contours.shp
#>                              quicklook
#> 1 /tmp/Rtmp0c0xKz/gw_IDW_quicklook.png
#>                              contour_manifest
#> 1 /tmp/Rtmp0c0xKz/gw_IDW_contour_manifest.csv
```
