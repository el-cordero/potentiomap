...
#> 1    IDW /tmp/RtmpLfMHVD/gw_IDW_surface.tif /tmp/RtmpLfMHVD/gw_IDW_contours.shp
#>                              quicklook
#> 1 /tmp/RtmpLfMHVD/gw_IDW_quicklook.png
#>                              contour_manifest
#> 1 /tmp/RtmpLfMHVD/gw_IDW_contour_manifest.csv
```
