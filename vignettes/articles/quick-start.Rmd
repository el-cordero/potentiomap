...
This workflow is runnable after `install.packages("potentiomap")`. It uses
released synthetic data in EPSG:26916. The head values are synthetic elevation
units rather than field measurements.
