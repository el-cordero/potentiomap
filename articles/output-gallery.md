...
Every image below is generated by the website build from `potentiomap`
0.1.0 objects. Synthetic head values are labeled as synthetic units and
should not be interpreted as field elevations. Warm colors represent
higher modeled head and cool colors represent lower modeled head;
contours, symbols, and arrowheads provide non-color cues.
