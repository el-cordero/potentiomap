...
#>                                                             contour_manifest
#> 1 /tmp/RtmprEMdN2/potentiomap-gis-example/synthetic_TPS_contour_manifest.csv
#> 2 /tmp/RtmprEMdN2/potentiomap-gis-example/synthetic_IDW_contour_manifest.csv
```
